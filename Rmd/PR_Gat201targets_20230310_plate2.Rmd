...
platemap <- read.csv("../Input/20230310_RPMI_Gat201Targets_Plate2_setup.csv") %>%     
            dplyr::mutate(
                    ...
                    levels = c("KN99 (WT)", "GAT201", "ECM2201", "MEP1","PDR802"),
                    labels = c("WT", "gat201∆", "ecm2201∆", "mep∆","pdr802∆"))
  )
head(platemap, n=10)
...
ggplot(data=normalisedOD %>%
       ...
       scale_y_continuous(limits=c(0,0.16),expand=c(0,0), breaks = c(0, 0.05, 0.15)) +
